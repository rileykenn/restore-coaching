...
const stages = [
  ...
  },
  {
    ...
    desc: [
      "When parenting starts to feel overwhelming, the answer isn't doing more—it's becoming more aware. This program helps you understand your patterns, triggers, and responses so you can show up with intention.",
      "As you shift, your child shifts. Patterns change, connection deepens, and emotional safety grows.",
  ...
  },
  {
    ...
    desc: [
      "Building on your awareness of patterns and triggers, this stage helps you understand your default reactions and where you need to lift.",
      "Through EQ assessment and coaching, we uncover underutilised behaviours and strengthen your capacity for emotional intelligence, regulation, and intentional response.",
      "With every step of growth you take, the impact flows outward, shaping your child's sense of connection, safety, and resilience.",
    ],
    color: "taupe",
    Icon: Brain,
  },
