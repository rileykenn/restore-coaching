...
export default function EQCoaching() {
  ...
  return (
    <section id="eq-coaching" className="section-padding bg-warm-white">
      <div className="max-w-[1600px] mx-auto px-8 xl:px-12">
        <ScrollReveal>
          <div className="text-center mb-20">
            <p className="text-taupe tracking-[0.3em] uppercase text-base mb-4 font-medium">
            ...
            <p className="mt-4 text-sage font-medium italic text-xl">
              Grow your self awareness. Strengthen how you lead, relate, and respond.
            </p>
          </div>
        </ScrollReveal>
