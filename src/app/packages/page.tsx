...
/* ────────────────────────────────────────────── */
/*  Motherhood Transition Packages               */
/* ────────────────────────────────────────────── */
const motherhoodPackages = [
  {
    ...
    inclusions: [
      ...
      "4 x weekly 1:1 coaching sessions (in-home or online)",
      "Personalised support tailored to you and your child\u2019s needs",
      "Additional sessions available at a reduced rate",
    ],
    footer: "Flexible payment options available",
    Icon: Baby,
    color: "sage",
    popular: false,
  },
  {
    title: "Restore Deepening",
    duration: "8 Weeks",
    ...
    inclusions: [
      "Restore Journal (your guided reflection companion)",
      "Birth Debrief session",
      "8 x weekly 1:1 coaching sessions (in-home or online)",
      "Personalised support tailored to you and your child\u2019s needs",
      "Additional sessions available at a reduced rate",
    ],
    footer: null,
  ...
  },
  {
    ...
    tagline:
      "I want to feel calm, confident, and fully myself in motherhood\u2014not just get through it.",
    inclusions: [
      "Restore Journal (your guided reflection companion)",
      "Birth Debrief session",
      "12 x weekly 1:1 coaching sessions (in-home or online)",
      "Personalised support tailored to you and your child\u2019s needs",
      "Additional sessions available at a reduced rate",
    ],
    footer: null,
  ...
  return (
    <>
      <ServicePageHero
        ...
        subtitle="Explore each package with clear inclusions and investment, so you can find the right fit for where you are right now."
      />
          ...
          <ScrollReveal>
            <div className="bg-white rounded-3xl p-10 md:p-14 shadow-sm border border-rose/15 hover:shadow-xl transition-all duration-500">
              ...
              <p className="text-charcoal-light text-lg leading-relaxed mb-8">
                A supportive space to process your birth experience as you enter
                motherhood, gain clarity, and move forward with confidence.
              </p>
              <div className="space-y-3 mb-8">
                {[
                  "60\u201390 minute 1:1 birth debrief session",
                  "Personalised coaching debrief summary",
      ...
      {/* ═══════════════════════════════════════
          MOTHERHOOD TRANSITION COACHING PACKAGES
      ═══════════════════════════════════════ */}
      <section className="py-14 md:py-20 bg-cream">
        <div className="max-w-[1400px] mx-auto px-8 xl:px-12">
          ...
          <div
            ref={motherhoodRef}
            className="grid md:grid-cols-3 gap-8 max-w-[1200px] mx-auto"
          >
            {motherhoodPackages.map((pkg, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-[var(--font-playfair)] text-xl md:text-2xl font-semibold text-charcoal mb-1">
                    {pkg.title}
                  </h3>
                  <p className="text-sage font-medium text-base mb-4">
                    {pkg.duration}
                  </p>
                  <div className="bg-sage/5 rounded-xl p-4 mb-5 space-y-1">
                    ...
                    <div className="flex justify-between text-base">
                      <span className="text-charcoal-light">Phone/Online:</span>
                      <span className="font-semibold text-charcoal">
                        {pkg.priceOnline}
                      </span>
                    </div>
                  </div>
                  <p className="text-charcoal italic text-base mb-6 font-[var(--font-playfair)]">
                    {pkg.tagline}
                  </p>
                  <div className="space-y-3 mb-6 flex-1">
                    {pkg.inclusions.map((item, j) => (
                      <div
                        key={j}
                        className="flex items-start gap-3 text-charcoal-light text-base"
                      >
              ...
              <div className="flex items-start gap-5 mb-2">
                ...
                <div>
                  ...
                  <p className="text-charcoal-light text-base mt-1 italic">
                    Group coaching available on request
                  </p>
                </div>
              </div>
          ...
          <ScrollReveal>
            <div className="bg-white rounded-3xl p-10 md:p-14 shadow-sm border border-sage/15 hover:shadow-xl transition-all duration-500">
              <div className="flex items-start gap-5 mb-6">
                ...
                <div>
                  <h3 className="font-[var(--font-playfair)] text-2xl md:text-3xl font-semibold text-charcoal">
                    Restore Monthly Ongoing Support
                  </h3>
                </div>
              </div>
              <p className="text-charcoal-light text-lg leading-relaxed mb-3">
                For parents and individuals who want continued support and guidance.
              </p>
              <p className="text-charcoal-light text-lg leading-relaxed mb-8">
                Ongoing coaching tailored to your needs, providing consistent
                support as you navigate parenting and life.
              </p>
              <p className="text-sage font-medium text-base mb-4">
                Can include:
              </p>
              <div className="space-y-3 mb-8">
                {[
                  ...
                  "Emotional regulation and real-life integration support",
              ...
              <div className="bg-sage/5 rounded-xl p-5">
                <p className="text-charcoal font-semibold text-lg">
                  Investment: Tailored to your level of support
                </p>
              </div>
            </div>
          </ScrollReveal>
      ...
      <section className="py-14 md:py-20 bg-cream">
        <div className="max-w-[900px] mx-auto px-8 xl:px-12">
          <ScrollReveal>
            <div className="bg-white rounded-3xl p-10 md:p-14 shadow-sm border border-taupe/15 hover:shadow-xl transition-all duration-500">
              <div className="flex items-start gap-5 mb-6">
                <div className="w-14 h-14 bg-taupe/10 rounded-2xl flex items-center justify-center flex-shrink-0">
                  <Brain className="w-7 h-7 text-taupe" />
                </div>
                <div>
                  <h3 className="font-[var(--font-playfair)] text-2xl md:text-3xl font-semibold text-charcoal">
                    Emotional Intelligence Coaching
                  </h3>
                  <p className="text-charcoal-light text-lg font-medium mt-1">
                    Investment: $950 AUD
                  </p>
                </div>
              </div>
              <p className="text-charcoal-light text-lg leading-relaxed mb-8">
                Strengthen your emotional intelligence and lead with clarity and
                confidence.
              </p>
              <div className="space-y-3 mb-8">
                {[
                  "Comprehensive EQ assessment and personalised report",
                  "90-minute results debrief",
                  "Two 60-minute coaching sessions (targeted + accountability)",
                  "3 personalised coaching email summaries",
                ].map((item, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-3 text-charcoal-light text-lg"
          ...
          <ScrollReveal>
            <div className="bg-sage/5 rounded-3xl p-10 md:p-14 border border-sage/10">
              ...
              <p className="text-charcoal-light text-lg leading-relaxed mb-8">
                ...
                for you in this season of motherhood.
              </p>
              <Link
                href="/contact"
